...
% \paragraph{Rectificador de onda completa en puente o con toma media} <<< Esto sería solo si tuvieramos un trafo en la entrada, pero al ser switching no hay trafo con toma media
...
La primer etapa se implementó en base a las topologías descritas en \cite{mohan}.
...
% Por que estaba como titulo "Driver" acá? ^^^
