...
\begin{itemize}
    ...
    \item Conductividad del cobre: $\sigma=5.96\times10^7Sm^{-1}$
...
$$ \delta=\sqrt{\frac{1}{\pi f\mu\sigma}}=\sqrt{\frac{1}{\pi\times125kHz\times1\times4\pi\times10^{-7}\times5.96\times10^{7}Sm^{-1}}}=0.18mm $$

El diámetro mínimo del conductor resulta:

$$ d_{min}=2\times\delta=0.36mm$$
...
Por lo que se fijó $B_m=200mT$ para reducir el número de vueltas.
...
La selección de transistores se realizó en base a la disponibilidad de los mismos en el laboratorio.
Se utilizó el par complementario 2N3904 (NPN)\cite{2n3904} y 2N3906 (PNP)\cite{2n3906}. Sus características principales son:
