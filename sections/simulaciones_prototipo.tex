...
\begin{figure}[H]
    ...
    \caption{Tensión en el secundario del transformador de potencia después de ajustar la relación de vueltas del transformador a 2:1}
    \label{fig:osc:41}
\end{figure}
...
como por ejemplo la resistencia del inductor del filtro de salida y pérdidas en los MOSFETs.
