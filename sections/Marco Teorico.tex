...
470pF<=Ct<=10uF
1.8kΩ<=Rt<=500kΩ
Para lograr la f=125kHz se eligió un capacitor de 1nF y para lograr la resistencia de 8kΩ se ajustó un potenciómetro de 10kΩ. 
...
1) Con el osciloscopio se mide la frecuencia de la oscilación en la tensión del transistor Vds. 
fr=
...
4) Teniendo la capacidad parásita del circuito Cp2 y la frecuencia de la oscilación original se puede calcular la inductancia parásita del circuito:
Lp=1/{[(2*pi*fr)^2]*Cp2}
...
Se agrega un capacitor de Bypass de 0.1uF para amortiguar la inductancia del MOSFET high side.
